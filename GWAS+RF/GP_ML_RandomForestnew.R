...
{
  geno1=read.table(args[3],sep=",",header=T)  
  dim(geno1)
  print(head(geno1))
  
  geno2=read.table(args[9],sep=",",header=T)  
  dim(geno2)
  print(head(geno2))
 
  geno_=rbind(geno1,geno2)
  geno = geno_[!duplicated(geno_),]
...
{
  geno1=read.table(args[4],sep=",",header=T)  
  dim(geno1)
  print(head(geno1))
  
  geno2=read.table(args[10],sep=",",header=T)  
  dim(geno2)
  print(head(geno2))
...
{
  geno1=read.table(args[5],sep=",",header=T)  
  dim(geno1)
  print(head(geno1))
  
  geno2=read.table(args[11],sep=",",header=T)  
  dim(geno2)
  print(head(geno2))
...
{
  geno1=read.table(args[6],sep=",",header=T)  
  dim(geno1)
  print(head(geno1))
  
  geno2=read.table(args[12],sep=",",header=T)  
  dim(geno2)
  print(head(geno2))
...
{
  ggeno1=read.table(args[7],sep=",",header=T)  
  dim(geno1)
  print(head(geno1))
  
  geno2=read.table(args[13],sep=",",header=T)  
  dim(geno2)
  print(head(geno2))
...
{
  geno1=read.table(args[8],sep=",",header=T)  
  dim(geno1)
  print(head(geno1))
  
  geno2=read.table(args[14],sep=",",header=T)  
  dim(geno2)
  print(head(geno2))
...
write.table(Combined,args[15],sep="\t",row.names=F,col.names=T,quote=F)
write.table(Correlation,args[16],sep="\t",row.names=F,col.names=T,quote=F)
write.table(Combined_weights,args[17],sep="\t",row.names=F,col.names=T,quote=F)