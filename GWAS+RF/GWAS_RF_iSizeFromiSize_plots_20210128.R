...
# GWAS iSize results
setwd("/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_iSizeByRF_20210201/pvals")
...
nrow(dataset_pvals_isize)%%60==0 # check if divisable by 60. It should be
}
...
# Upload top 200 SNPs
{
  setwd("/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_iSizeByRF_20210201/top200")
...
# plot an extra layer that assigns dot size after occurence
{
  ...
  p1
  ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_iSizeByRF_20210201/iSizepredictioncorrelations/Manhattanplot_iSizefromiSize',Sys.Date(),'.pdf',sep="_"), plot = p1, width = 25, height = 15, unit = 'cm')
}
...
# plot an extra layer that assigns dot colour after occurence
{
  ...
  ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_iSizeByRF_20210201/iSizepredictioncorrelations/iSizefromIsize_Manhattan_ColourafterOccurence',Sys.Date(),'.pdf',sep="_"), plot = p_coloured, width = 25, height = 15, unit = 'cm')
}
...
ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_iSizeByRF_20210201/iSizepredictioncorrelations/iSizefromiSize_Manhattan_ColourafterOccurenceOnly90perc',Sys.Date(),'.pdf',sep="_"), plot = p_coloured_only90, width = 35, height = 15, unit = 'cm')
...
setwd("/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_iSizeByRF_20210201/weights")
...
ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_iSizeByRF_20210201/iSizepredictioncorrelations/isizefromisize_Manhattan_ColourafterOccurenceSizeAfterWeightOnly90perc_top200',Sys.Date(),'.pdf',sep="_"), plot = p_colouredScaled_only90, width = 45, height = 15, unit = 'cm')
...
ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_iSizeByRF_20210201/iSizepredictioncorrelations/isizefromisize_Manhattan_ColourafterOccurenceSizeAfterWeightOnly90perc_backgroundcol_top200',Sys.Date(),'.pdf',sep="_"), plot = p_colouredScaled_only90_, width = 75, height = 15, unit = 'cm')
ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_iSizeByRF_20210201/iSizepredictioncorrelations/isizefromisize_Manhattan_ColourafterOccurenceSizeAfterWeightOnly90perc_backgroundcol_top200',Sys.Date(),'.png',sep="_"), plot = p_colouredScaled_only90_, width = 75, height = 15, unit = 'cm')
...
# Upload top 25 SNPs
{
  setwd("/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_iSizeByRF_20210201/top25")
...
# plot an extra layer that assigns dot size after occurence
{
  ...
  p1
  ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_iSizeByRF_20210201/iSizepredictioncorrelations/Manhattanplot_iSizefromiSize_top25',Sys.Date(),'.pdf',sep="_"), plot = p1, width = 25, height = 15, unit = 'cm')
}
...
# plot an extra layer that assigns dot colour after occurence
{
  ...
  ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_iSizeByRF_20210201/iSizepredictioncorrelations/iSizefromIsize_Manhattan_ColourafterOccurencetop25',Sys.Date(),'.pdf',sep="_"), plot = p_coloured, width = 25, height = 15, unit = 'cm')
}
...
ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_iSizeByRF_20210201/iSizepredictioncorrelations/isizefromisize_Manhattan_ColourafterOccurenceSizeAfterWeightOnly90perc_top25',Sys.Date(),'.pdf',sep="_"), plot = p_colouredScaled_only90, width = 45, height = 15, unit = 'cm')
...
ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_iSizeByRF_20210201/iSizepredictioncorrelations/isizefromisize_Manhattan_ColourafterOccurenceSizeAfterWeightOnly90perc_backgroundcol_top25',Sys.Date(),'.pdf',sep="_"), plot = p_colouredScaled_only90_, width = 75, height = 15, unit = 'cm')
ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_iSizeByRF_20210201/iSizepredictioncorrelations/isizefromisize_Manhattan_ColourafterOccurenceSizeAfterWeightOnly90perc_backgroundcol_top25',Sys.Date(),'.png',sep="_"), plot = p_colouredScaled_only90_, width = 75, height = 15, unit = 'cm')
