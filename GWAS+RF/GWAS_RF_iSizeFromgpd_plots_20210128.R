...
# GWAS gpd results
setwd("/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_gpdbyRF_20210202/pvals")
...
nrow(dataset_pvals_gpd)%%60==0 # check if divisable by 60. It should be
}
...
# Upload top 200 SNPs
{
  setwd("/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_gpdbyRF_20210202/top200")
...
# plot an extra layer that assigns dot size after occurence
{
  ...
  p1
  #ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_gpdbyRF_20210202/Manhattanplot_gpdfromgpd',Sys.Date(),'.pdf',sep="_"), plot = p1, width = 25, height = 15, unit = 'cm')
}
...
# plot an extra layer that assigns dot colour after occurence
{
  ...
  #ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_gpdbyRF_20210202/gpdfromgpd_Manhattan_ColourafterOccurencetop200',Sys.Date(),'.pdf',sep="_"), plot = p_coloured, width = 25, height = 15, unit = 'cm')
}
...
#ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_gpdbyRF_20210202/gpdfromgpd_Manhattan_ColourafterOccurenceOnly90perctop200',Sys.Date(),'.pdf',sep="_"), plot = p_coloured_only90, width = 35, height = 15, unit = 'cm')
...
setwd("/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_gpdbyRF_20210202/weights")
...
ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_gpdbyRF_20210202/isizefromgpd_Manhattan_ColourafterOccurencegpdAfterWeightOnly90perc_top200',Sys.Date(),'.pdf',sep="_"), plot = p_colouredScaled_only90, width = 45, height = 15, unit = 'cm')
...
p_colouredScaled_only90_ <- p  + geom_point(data=extralayer_only90_w_weightTop200, aes(x=BPcum, y=-log10(scores), color=Occurence,size=avgweight)) + scale_color_viridis(option = "plasma") +  scale_size(range = c(2,8)) + theme(legend.position = "right") 
p_colouredScaled_only90_

ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_gpdbyRF_20210202/isizefromgpd_Manhattan_ColourafterOccurencegpdAfterWeightOnly90perc_backgroundcol_top200',Sys.Date(),'.pdf',sep="_"), plot = p_colouredScaled_only90_, width = 75, height = 15, unit = 'cm')
ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_gpdbyRF_20210202/sizefromgpd_Manhattan_ColourafterOccurencegpdAfterWeightOnly90perc_backgroundcol_top200',Sys.Date(),'.png',sep="_"), plot = p_colouredScaled_only90_, width = 75, height = 15, unit = 'cm')
...
# Upload top 25 SNPs
{
  setwd("/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_gpdbyRF_20210202/top25")
...
# plot an extra layer that assigns dot size after occurence
{
  ...
  p1
  #ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_gpdbyRF_20210202/Manhattanplot_iSizefromgpd_top25',Sys.Date(),'.pdf',sep="_"), plot = p1, width = 25, height = 15, unit = 'cm')
}
...
# plot an extra layer that assigns dot colour after occurence
{
  ...
  #ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_gpdbyRF_20210202/gpdfromgpd_Manhattan_ColourafterOccurencetop25',Sys.Date(),'.pdf',sep="_"), plot = p_coloured, width = 25, height = 15, unit = 'cm')
}
...
ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_gpdbyRF_20210202/iSizefromgpd_Manhattan_ColourafterOccurencegpdAfterWeightOnly90perc_top25',Sys.Date(),'.pdf',sep="_"), plot = p_colouredScaled_only90, width = 45, height = 15, unit = 'cm')
...
p_colouredScaled_only90_ <- p  + geom_point(data=extralayer_only90_w_weightTop25, aes(x=BPcum, y=-log10(scores), color=Occurence,size=avgweight)) + scale_color_viridis(option = "plasma") +  scale_size(range = c(2,8)) + theme(legend.position = "right") 
p_colouredScaled_only90_

ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_gpdbyRF_20210202/iSizefromgpd_Manhattan_ColourafterOccurencgpdAfterWeightOnly90perc_backgroundcol_top25',Sys.Date(),'.pdf',sep="_"), plot = p_colouredScaled_only90_, width = 75, height = 15, unit = 'cm')
ggsave(paste('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/GWAS_gpdbyRF_20210202/iSizefromgpd_Manhattan_ColourafterOccurencgpdAfterWeightOnly90perc_backgroundcol_top25',Sys.Date(),'.png',sep="_"), plot = p_colouredScaled_only90_, width = 75, height = 15, unit = 'cm')
