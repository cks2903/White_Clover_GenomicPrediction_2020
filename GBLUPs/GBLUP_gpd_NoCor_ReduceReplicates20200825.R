...
Correcterfunction<-function(dataframe){
  ...
  # Function that takes in a dataframe and calculates the corrected phenotype
...
# Summarize and make files with results
{
  ...
  colnames(Combined)=c("Individual","gpd_NoCor","Observed_correctedForFixed","GEBVs","SD_gpdNoCor","SD_CorrectedPheno")
  ...
  filename=paste("Correlation_gpdNoCor_GBLUP_GPD_10Replicates",round,".txt",sep="")
...
# Summarize and make files with results
{
  ...
  Combined=cbind(All1[,1],Gpdmean[,2],All1[,2],All2[,2],StandardDeviation_gpdRes[,2],StandardDeviation_corrected[,2])
  colnames(Combined)=c("Individual","gpd_Nocor","Observed_correctedForFixed","GEBVs","SD_NoResCor","SD_CorrectedPheno")
  
  filename=paste("Correlation_Correctedphenotype_GBLUP_GPD_9Replicates",round,".txt",sep="")
  write.table(correlation1,filename,sep="\t",quote=F)
  
  filename=paste("Correlation_gpdNoCor_GBLUP_GPD_9Replicates",round,".txt",sep="")
  write.table(correlation2,filename,sep="\t",quote=F)
...
# Summarize and make files with results
{
  ...
  filename=paste("Correlation_gpdNoCor_GBLUP_GPD_8Replicates",round,".txt",sep="")
  write.table(correlation2,filename,sep="\t",quote=F)
...
# Summarize and make files with results
{
  ...
  filename=paste("Correlation_gpdNoCor_GBLUP_GPD_7Replicates",round,".txt",sep="")
  write.table(correlation2,filename,sep="\t",quote=F)
...
# Summarize and make files with results
{
  ...
  filename=paste("Correlation_gpdNoCor_GBLUP_GPD_6Replicates",round,".txt",sep="")
  write.table(correlation2,filename,sep="\t",quote=F)
...
# Summarize and make files with results
{
  ...
  filename=paste("Correlation_gpdNoCor_GBLUP_GPD_5Replicates",round,".txt",sep="")
  write.table(correlation2,filename,sep="\t",quote=F)
...
# Summarize and make files with results
{
  ...
  filename=paste("Correlation_gpdNoCor_GBLUP_GPD_4Replicates",round,".txt",sep="")
  write.table(correlation2,filename,sep="\t",quote=F)
...
# Summarize and make files with results
{
  ...
  filename=paste("Correlation_gpdNoCor_GBLUP_GPD_3Replicates",round,".txt",sep="")
  write.table(correlation2,filename,sep="\t",quote=F)
...
# Summarize and make files with results
{
  ...
  filename=paste("Correlation_gpdNoCor_GBLUP_GPD_2Replicates",round,".txt",sep="")
  write.table(correlation2,filename,sep="\t",quote=F)
