...
GP_GBLUP<-function(testpop){
  ...
  gpdmeans_training_ready=na.omit(gpdmeans_training, cols = c("gpdNoCor")) # remember that gpd na inidividuals should be removed whether or not they are in the training pop or not
