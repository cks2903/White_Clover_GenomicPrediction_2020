...
if (is.na(args[3])){
  set.seed(NULL)
  tst=sample(1:length(unique(iSizemeans$Individual)),size=length(unique(iSizemeans$Individual)),replace=FALSE) 
  k=6
  ...
  testpop1=unique(iSizemeans$Individual)[tst1]
  testpop2=unique(iSizemeans$Individual)[tst2]
  testpop3=unique(iSizemeans$Individual)[tst3]
  testpop4=unique(iSizemeans$Individual)[tst4]
  testpop5=unique(iSizemeans$Individual)[tst5]
  testpop6=unique(iSizemeans$Individual)[tst6]
  
  testpop1_idx=which(iSizemeans$Individual %in% testpop1)
  testpop2_idx=which(iSizemeans$Individual %in% testpop2)
  testpop3_idx=which(iSizemeans$Individual %in% testpop3)
  testpop4_idx=which(iSizemeans$Individual %in% testpop4)
  testpop5_idx=which(iSizemeans$Individual %in% testpop5)
  testpop6_idx=which(iSizemeans$Individual %in% testpop6)
