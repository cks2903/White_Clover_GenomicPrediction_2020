...
# plot an extra layer that assigns dot size after occurence
{
  ...
  p1
  ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/Manhattanplot_iSizefromgpd',Sys.Date(),'.pdf',sep="_"), plot = p1, width = 25, height = 15, unit = 'cm')
}
...
# plot an extra layer that assigns dot colour after occurence
{
  ...
  ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/iSizefromgpd_Manhattan_ColourafterOccurencetop200',Sys.Date(),'.pdf',sep="_"), plot = p_coloured, width = 25, height = 15, unit = 'cm')
}
...
ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/iSizefromgpd_Manhattan_ColourafterOccurenceOnly90perctop200',Sys.Date(),'.pdf',sep="_"), plot = p_coloured_only90, width = 35, height = 15, unit = 'cm')
...
setwd("/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/GWAS_gpd_followedByRF_20210201/weights_iSizefromgpd")
...
ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/iSizefromgpd_Manhattan_ColourafterOccurencegpdAfterWeightOnly90perc_top200',Sys.Date(),'.pdf',sep="_"), plot = p_colouredScaled_only90, width = 45, height = 15, unit = 'cm')
...
p_colouredScaled_only90_ <- p  + 
  geom_point(data=extralayer_only90_w_weightTop200, aes(x=BPcum, y=-log10(scores), color=Occurence,size=avgweight)) +
...
ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/iSizefromgpd_Manhattan_ColourafterOccurencegpdAfterWeightOnly90perc_backgroundcol_top200',Sys.Date(),'.pdf',sep="_"), plot = p_colouredScaled_only90_, width = 75, height = 15, unit = 'cm')
ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/iSizefromgpd_Manhattan_ColourafterOccurencegpdAfterWeightOnly90perc_backgroundcol_top200',Sys.Date(),'.png',sep="_"), plot = p_colouredScaled_only90_, width = 75, height = 15, unit = 'cm')
...
# plot an extra layer that assigns dot size after occurence
{
  ...
  p1
  ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/Manhattanplot_iSizefromgpd_top25',Sys.Date(),'.pdf',sep="_"), plot = p1, width = 25, height = 15, unit = 'cm')
}
...
# plot an extra layer that assigns dot colour after occurence
{
  ...
  ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/iSizefromgpd_Manhattan_ColourafterOccurencetop25',Sys.Date(),'.pdf',sep="_"), plot = p_coloured, width = 25, height = 15, unit = 'cm')
}
...
ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/iSizefromgpd_Manhattan_ColourafterOccurencegpdAfterWeightOnly90perc_top25',Sys.Date(),'.pdf',sep="_"), plot = p_colouredScaled_only90, width = 45, height = 15, unit = 'cm')
...
ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/iSizefromgpd_Manhattan_ColourafterOccurencgpdAfterWeightOnly90perc_backgroundcol_top25',Sys.Date(),'.pdf',sep="_"), plot = p_colouredScaled_only90_, width = 75, height = 15, unit = 'cm')
ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/iSizefromgpd_Manhattan_ColourafterOccurencgpdAfterWeightOnly90perc_backgroundcol_top25',Sys.Date(),'.png',sep="_"), plot = p_colouredScaled_only90_, width = 75, height = 15, unit = 'cm')
