...
# GWAS iSize results
setwd("/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/GWAS_iSize_followedByRF_20210201/pvals_GWAS_iSize")
...
print(paste("p-values from this many:"),length(file_list),sep=" ") #should be 600


for (file in file_list){
  
  # if the merged dataset doesn't exist, create it
  if (!exists("dataset_pvals_isize")){
    dataset_pvals_isize <- read.table(file, header=TRUE, sep=",")
  }
  
  # if the merged dataset does exist, append to it
  if (exists("dataset_pvals_isize")){
    pred_dataset <-read.table(file, header=TRUE, sep=",")
    dataset_pvals_isize<-rbind(dataset_pvals_isize, pred_dataset)
    rm(pred_dataset)
  }
}

dataset_pvals_isize=as.data.frame(dataset_pvals_isize)
head(dataset_pvals_isize)
nrow(dataset_pvals_isize)%%600==0 # check if divisable by 60. It should be
}


# Calculate average p-values
{
dataset_pvals_isize$identifier = paste(dataset_pvals_isize$chromosomes,dataset_pvals_isize$positions, sep='-')
head(dataset_pvals_isize)
Pvals=aggregate(dataset_pvals_isize$scores, list(dataset_pvals_isize$identifier), mean)
chromosomes=aggregate(dataset_pvals_isize$chromosomes, list(dataset_pvals_isize$identifier), mean)
positions=aggregate(dataset_pvals_isize$positions, list(dataset_pvals_isize$identifier), mean)
mafs=aggregate(dataset_pvals_isize$mafs, list(dataset_pvals_isize$identifier), mean)
...
# Plotting
{
  ...
  p <- ggplot(don, aes(x=BPcum, y=-log10(scores))) +
    ...
    labs(y = ("-log10(p-value)"), x = ("Chromosome"), title = ("iSize"))
...
# Upload top 200 SNPs
{
  setwd("/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/GWAS_iSize_followedByRF_20210201/top200iSize")
...
# Calculate number of occurences for each snp in top 200 
{
  ...
  write.table(count_occurence,"occurence_top200SNPs_iSize.txt")
...
# plot an extra layer that assigns dot size after occurence
{
  ...
  p1
  ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/Manhattanplot_iSizefromiSize',Sys.Date(),'.pdf',sep="_"), plot = p1, width = 25, height = 15, unit = 'cm')
}
...
# plot an extra layer that assigns dot colour after occurence
{
  ...
  ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/iSizefromIsize_Manhattan_ColourafterOccurence',Sys.Date(),'.pdf',sep="_"), plot = p_coloured, width = 25, height = 15, unit = 'cm')
}
...
ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/iSizefromiSize_Manhattan_ColourafterOccurenceOnly90perc',Sys.Date(),'.pdf',sep="_"), plot = p_coloured_only90, width = 35, height = 15, unit = 'cm')



# Load in weights when predicting iSize
{

setwd("/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/GWAS_iSize_followedByRF_20210201/weights_iSizefromiSize")

list.files()
file_list <- list.files(pattern="Weights_iSize_RF_top200SNPs")
...
ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/isizefromisize_Manhattan_ColourafterOccurenceSizeAfterWeightOnly90perc_top200',Sys.Date(),'.pdf',sep="_"), plot = p_colouredScaled_only90, width = 45, height = 15, unit = 'cm')
...
p_colouredScaled_only90_ <- p  + geom_point(data=extralayer_only90_w_weightTop200, aes(x=BPcum, y=-log10(scores), color=Occurence,size=avgweight)) + 
...
ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/isizefromisize_Manhattan_ColourafterOccurenceSizeAfterWeightOnly90perc_backgroundcol_top200',Sys.Date(),'.pdf',sep="_"), plot = p_colouredScaled_only90_, width = 75, height = 15, unit = 'cm')
ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/isizefromisize_Manhattan_ColourafterOccurenceSizeAfterWeightOnly90perc_backgroundcol_top200',Sys.Date(),'.png',sep="_"), plot = p_colouredScaled_only90_, width = 75, height = 15, unit = 'cm')
...
# Upload top 25 SNPs
{
  setwd("/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/GWAS_iSize_followedByRF_20210201/top25iSize")
...
# Calculate number of occurences for each snp in top 200 
{
  ...
  write.table(count_occurence,"occurence_top25SNPs_iSize.txt")
...
# plot an extra layer that assigns dot size after occurence
{
  ...
  p1
  ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/Manhattanplot_iSizefromiSize_top25',Sys.Date(),'.pdf',sep="_"), plot = p1, width = 25, height = 15, unit = 'cm')
}
...
# plot an extra layer that assigns dot colour after occurence
{
  ...
  ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/iSizefromIsize_Manhattan_ColourafterOccurencetop25',Sys.Date(),'.pdf',sep="_"), plot = p_coloured, width = 25, height = 15, unit = 'cm')
}
...
ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/iSizefromiSize_Manhattan_ColourafterOccurenceOnly90perctop25',Sys.Date(),'.pdf',sep="_"), plot = p_coloured_only90, width = 35, height = 15, unit = 'cm')
...
# Load in weights when predicting iSize
{
  ...
  list.files()
  file_list <- list.files(pattern="Weights_iSize_RF_top25SNPs")
...
ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/isizefromisize_Manhattan_ColourafterOccurenceSizeAfterWeightOnly90perc_top25',Sys.Date(),'.pdf',sep="_"), plot = p_colouredScaled_only90, width = 45, height = 15, unit = 'cm')
...
ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/isizefromisize_Manhattan_ColourafterOccurenceSizeAfterWeightOnly90perc_backgroundcol_top25',Sys.Date(),'.pdf',sep="_"), plot = p_colouredScaled_only90_, width = 75, height = 15, unit = 'cm')
ggsave(paste('/home/cks/NChain/faststorage/WHITE_CLOVER/GP_V3_July2020_CKS_LessQualityFiltering/GP_20201120_Averages/Figures/isizefromisize_Manhattan_ColourafterOccurenceSizeAfterWeightOnly90perc_backgroundcol_top25',Sys.Date(),'.png',sep="_"), plot = p_colouredScaled_only90_, width = 75, height = 15, unit = 'cm')
