...
{
  setwd("/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/Replicate_Reduction_20200831/gpd_ResCor")
}
...
ForPlotting_10REPs = data.frame(matrix(vector(), numberofrounds, 5,
                       dimnames=list(c(), c("cor_gpdResCor_GEBV","cor_CorrectedPheno_GEBV","Average_SD_CorrectedPheno","Average_SD_gpdResCor","Round"))),
                stringsAsFactors=F)
...
for (j in unique(dataframeWithResults_10reps$Round)){
  ...
  j=as.numeric(j)
  ForPlotting_10REPs$cor_gpdResCor_GEBV[j] = cor(subtable$gpd_rescor,subtable$GEBVs)
  ...
  ForPlotting_10REPs$Average_SD_gpdResCor[j] = mean(subtable$SD_gpdResCor)
  ForPlotting_10REPs$Average_SE_gpdResCor[j] = ForPlotting_10REPs$Average_SD_gpdResCor[j]/sqrt(10)
...
ForPlotting_9REPs = data.frame(matrix(vector(), numberofrounds, 5,
                                       dimnames=list(c(), c("cor_gpdResCor_GEBV","cor_CorrectedPheno_GEBV","Average_SD_CorrectedPheno","Average_SD_gpdResCor","Round"))),
                                stringsAsFactors=F)
...
for (j in unique(dataframeWithResults_9reps$Round)){
  ...
  j=as.numeric(j)
  ForPlotting_9REPs$cor_gpdResCor_GEBV[j] = cor(subtable$gpd_rescor,subtable$GEBVs)
  ...
  ForPlotting_9REPs$Average_SD_gpdResCor[j] = mean(subtable$SD_gpdResCor)
  ForPlotting_9REPs$Average_SE_gpdResCor[j] = ForPlotting_9REPs$Average_SD_gpdResCor[j]/sqrt(9)
...
for (j in unique(dataframeWithResults_8reps$Round)){
  ...
  j=as.numeric(j)
  ForPlotting_8REPs$cor_gpdResCor_GEBV[j] = cor(subtable$gpd_rescor,subtable$GEBVs)
  ...
  ForPlotting_8REPs$Average_SD_gpdResCor[j] = mean(subtable$SD_gpdResCor)
  ForPlotting_8REPs$Average_SE_gpdResCor[j] = ForPlotting_8REPs$Average_SD_gpdResCor[j]/sqrt(8)
...
for (j in unique(dataframeWithResults_7reps$Round)){
  ...
  j=as.numeric(j)
  ForPlotting_7REPs$cor_gpdResCor_GEBV[j] = cor(subtable$gpd_rescor,subtable$GEBVs)
  ...
  ForPlotting_7REPs$Average_SD_gpdResCor[j] = mean(subtable$SD_gpdResCor)
  ForPlotting_7REPs$Average_SE_gpdResCor[j] = ForPlotting_7REPs$Average_SD_gpdResCor[j]/sqrt(7)
...
for (j in unique(dataframeWithResults_6reps$Round)){
  ...
  j=as.numeric(j)
  ForPlotting_6REPs$cor_gpdResCor_GEBV[j] = cor(subtable$gpd_rescor,subtable$GEBVs)
  ...
  ForPlotting_6REPs$Average_SD_gpdResCor[j] = mean(subtable$SD_gpdResCor)
  ForPlotting_6REPs$Average_SE_gpdResCor[j] = ForPlotting_6REPs$Average_SD_gpdResCor[j]/sqrt(6)
...
for (j in unique(dataframeWithResults_5reps$Round)){
  ...
  j=as.numeric(j)
  ForPlotting_5REPs$cor_gpdResCor_GEBV[j] = cor(subtable$gpd_rescor,subtable$GEBVs)
  ...
  ForPlotting_5REPs$Average_SD_gpdResCor[j] = mean(subtable$SD_gpdResCor)
  ForPlotting_5REPs$Average_SE_gpdResCor[j] = ForPlotting_5REPs$Average_SD_gpdResCor[j]/sqrt(5)
...
for (j in unique(dataframeWithResults_4reps$Round)){
  ...
  j=as.numeric(j)
  ForPlotting_4REPs$cor_gpdResCor_GEBV[j] = cor(subtable$gpd_rescor,subtable$GEBVs)
  ...
  ForPlotting_4REPs$Average_SD_gpdResCor[j] = mean(subtable$SD_gpdResCor)
  ForPlotting_4REPs$Average_SE_gpdResCor[j] = ForPlotting_4REPs$Average_SD_gpdResCor[j]/sqrt(4)
...
for (j in unique(dataframeWithResults_3reps$Round)){
  ...
  j=as.numeric(j)
  ForPlotting_3REPs$cor_gpdResCor_GEBV[j] = cor(subtable$gpd_rescor,subtable$GEBVs)
  ...
  ForPlotting_3REPs$Average_SD_gpdResCor[j] = mean(subtable$SD_gpdResCor)
  ForPlotting_3REPs$Average_SE_gpdResCor[j] = ForPlotting_3REPs$Average_SD_gpdResCor[j]/sqrt(3)
...
for (j in unique(dataframeWithResults_2reps$Round)){
  ...
  j=as.numeric(j)
  ForPlotting_2REPs$cor_gpdResCor_GEBV[j] = cor(subtable$gpd_rescor,subtable$GEBVs)
  ...
  ForPlotting_2REPs$Average_SD_gpdResCor[j] = mean(subtable$SD_gpdResCor)
  ForPlotting_2REPs$Average_SE_gpdResCor[j] = ForPlotting_2REPs$Average_SD_gpdResCor[j]/sqrt(2)
...
write.table(AllDataForplotting,file="/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/Replicate_Reduction_20200831/replicate_reduction_gpdResCor.txt",sep="\t",quote=F,col.names = T, row.names = F)
...
p1=ggplot(AllDataForplotting, aes(x=Replicates, y=cor_gpdResCor_GEBV)) + 
  #geom_errorbar(aes(ymin=lower, ymax=upper), width=.1, position=pd) +
  #geom_line(position=pd) +
  geom_point(position=pd) +
  ylim(min(AllDataForplotting$cor_gpdResCor_GEBV),max(AllDataForplotting$cor_gpdResCor_GEBV)) +
  scale_x_reverse() +
  xlab("Replicates") +
  ylab("Correlation") +
  theme_classic()
...
ggsave('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/Replicate_Reduction_20200831/Figures/cor_of_gpdResCorAndGEBV.pdf', plot = p1, width = 15, height = 15, unit = 'cm')
...
ggsave('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/Replicate_Reduction_20200831/Figures/cor_of_CorrectedPheno(gpd_ResCor)AndGEBV.pdf', plot = p2, width = 15, height = 15, unit = 'cm')

# Correlation between gpd_ResCor and GEBVs, means with standard deviations
Means_cor_gpdResCor_GEBV=aggregate(AllDataForplotting$cor_gpdResCor_GEBV, list(AllDataForplotting$Replicates), mean)
...
STDEV_cor_gpdResCor_GEBV=aggregate(AllDataForplotting$cor_gpdResCor_GEBV, list(AllDataForplotting$Replicates), sd)
...
ggsave('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/Replicate_Reduction_20200831/Figures/cor_of_gpdResCorAndGEBV_averages_withSD.pdf', plot = p3, width = 15, height = 15, unit = 'cm')


# Correlation between gpd_ResCor and GEBVs, means with standard errors
Means_cor_gpdResCor_GEBV_SE=aggregate(AllDataForplotting$cor_gpdResCor_GEBV, list(AllDataForplotting$Replicates), mean)
...
STDEV_cor_gpdResCor_GEBV=aggregate(AllDataForplotting$cor_gpdResCor_GEBV, list(AllDataForplotting$Replicates), sd)
STERR_cor_gpdResCor_GEBV=STDEV_cor_gpdResCor_GEBV/sqrt(100)
...
p4
ggsave('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/Replicate_Reduction_20200831/Figures/cor_of_gpdResCorAndGEBV_averages_withSE.pdf', plot = p4, width = 15, height = 15, unit = 'cm')
...
ggsave('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/Replicate_Reduction_20200831/Figures/cor_of_CorrectedPheno(gpd_ResCor)AndGEBV_averages_withSD.pdf', plot = p5, width = 15, height = 15, unit = 'cm')

p55=ggplot(Means_cor_CorrectedPheno_GEBV, aes(x=Replicates, y=Means_cor_correctedpheno_GEBV)) + 
  geom_line(position=pd,color=wes_palette("Rushmore1")[3]) +
  geom_point(color=wes_palette("Rushmore1")[3]) +
  geom_errorbar(aes(ymin=lower, ymax=upper), width=.05, position=pd,color=wes_palette("Rushmore1")[3]) +
  #ylim(0,0.4) +
  scale_x_reverse() +
  xlab("Replicates") +
  ylab("Correlation") +
...
p55
ggsave('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/Replicate_Reduction_20200831/Figures/cor_of_CorrectedPheno(gpd_ResCor)AndGEBV_averages_withSD_coloured.pdf', plot = p5, width = 15, height = 15, unit = 'cm')
...
ggsave('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/Replicate_Reduction_20200831/Figures/cor_of_CorrectedPheno(gpd_ResCor)AndGEBV_averages_withSE.pdf', plot = p6, width = 15, height = 15, unit = 'cm')




# plot SD of average gpd_ResCor
Mean_avg_SD_gpdResCor=aggregate(AllDataForplotting$Average_SD_gpdResCor, list(AllDataForplotting$Replicates), mean)
Mean_avg_SD_gpdResCor
Mean_avg_SD_gpdResCor=as.data.frame(Mean_avg_SD_gpdResCor)
colnames(Mean_avg_SD_gpdResCor)=c("Replicates","Mean_avg_SD_gpdResCor")

p7=ggplot(Mean_avg_SD_gpdResCor, aes(x=Replicates, y=Mean_avg_SD_gpdResCor)) + 
  geom_line(position=pd) +
  geom_point() +
  #geom_errorbar(aes(ymin=lower, ymax=upper), width=.05, position=pd) +
  #ylim(0,0.4) +
  scale_x_reverse() +
  xlab("Replicates") +
  ylab("Avg. Standard deviation of gpd_ResCor estimates") +
  theme_classic()

p7

ggsave('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/Replicate_Reduction_20200831/Figures/Mean_avg_SD_gpdResCor.pdf', plot = p7, width = 15, height = 15, unit = 'cm')
...
ggsave('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/Replicate_Reduction_20200831/Figures/Mean_avg_SD_CorrectedPheno(gpd_ResCor).pdf', plot = p8, width = 15, height = 15, unit = 'cm')
...
ggsave('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/Replicate_Reduction_20200831/Figures/Mean_avg_SE_CorrectedPheno(gpd_ResCor).pdf', plot = p9, width = 15, height = 15, unit = 'cm')


# plot SE of average gpd_resCor 
Mean_avg_SE_gpdResCor=aggregate(AllDataForplotting$Average_SE_gpdResCor, list(AllDataForplotting$Replicates), mean)
colnames(Mean_avg_SE_gpdResCor)=c("Replicates","Mean_avg_SE_gpdRescor")

p10=ggplot(Mean_avg_SE_gpdResCor, aes(x=Replicates, y=Mean_avg_SE_gpdRescor)) + 
  geom_line(position=pd) +
  geom_point() +
  #geom_errorbar(aes(ymin=lower, ymax=upper), width=.05, position=pd) +
  #ylim(0,0.4) +
  scale_x_reverse() +
  xlab("Replicates") +
  ylab("Avg. Standard error of gpd_ResCor estimates") +
  theme_classic()

p10

ggsave('/Volumes/NAT_MBG-PMg/Cathrine/Nchain/Genomic_prediction_yield_July2020/V2_LessHarsh_SaraQualityFilter/Replicate_Reduction_20200831/Figures/Mean_avg_SE_gpdResCor.pdf', plot = p10, width = 15, height = 15, unit = 'cm')
...
# Calculate FDR (when rejecting null-hypothesis when actually true. That means the cases where a lower replicate number do no actually not show a lower correlation than at 10 replicates) 
...
# for SE of gpd_rescor 
t.test(AllDataForplotting[which(AllDataForplotting$Replicates==10),7], AllDataForplotting[which(AllDataForplotting$Replicates==9),7], paired = FALSE, alternative = "less") # ***
